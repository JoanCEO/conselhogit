      ...
      <header className={styles.header}>
        <div className={styles.headerInner}>
          ...
          <nav className={styles.nav}>
            ...
            <Link to="/links" className={`${styles.navLink} ${location.pathname === '/links' ? styles.navActive : ''}`}>Links</Link>
          </nav>
        ...
        <>
          ...
          <div className={styles.mobileDrawer}>
            ...
            <nav className={styles.drawerNav}>
              <button onClick={() => navTo('/')} className={`${styles.drawerLink} ${location.pathname === '/' ? styles.drawerActive : ''}`}>Avaliações</button>
              <button onClick={() => navTo('/convocacoes')} className={`${styles.drawerLink} ${location.pathname === '/convocacoes' ? styles.drawerActive : ''}`}>Convocações</button>
              <button onClick={() => navTo('/links')} className={`${styles.drawerLink} ${location.pathname === '/links' ? styles.drawerActive : ''}`}>Links</button>
              <button onClick={() => navTo(`/profile/${profile?.id}`)} className={styles.drawerLink}>Meu Perfil</button>
            </nav>
